...
map.getView().fit([-13175416.262566, 1636965.723822, -9656027.017398, 3857249.383954], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">VÍCTIMAS REPORTADAS POR DELITO DE HOMICIDIO 2025</h2>';
        return titleElement;
    })(),
